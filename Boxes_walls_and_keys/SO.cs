...
namespace Boxes_walls_and_keys
{
    ...
    {
        //general
        //public static Point window_wh = new Point(800, 600);
        ...
        //shadows
        public static Image full_shadow = Image.FromFile("..\\Images\\Shadows\\full_shadow.png");        
        ...
        public static readonly Square[] square_types = new Square[]
            {
               ...
               new Square(Image.FromFile("..\\Images\\box_floor.png"), false, 5), //5 - box
